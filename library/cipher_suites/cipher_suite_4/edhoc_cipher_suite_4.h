...
/* Header guard ------------------------------------------------------------ */
#ifndef EDHOC_CIPHER_SUITE_4_H
#define EDHOC_CIPHER_SUITE_4_H
...
/** \defgroup edhoc-cipher-suite-4-api EDHOC cipher suite 4 API
 * @{
 */
...
/** 
 * \brief Get EDHOC keys structure for cipher suite 4.
 *
 * Returns a pointer to the key management operations structure implementing
 * cipher suite 4 key handling.
 *
 * \return Pointer to cipher suite 4 keys operations structure.
 */
const struct edhoc_keys *edhoc_cipher_suite_4_get_keys(void);

/**
 * \brief Get EDHOC cipher suite descriptor for cipher suite 4.
 *
...
/** 
 * \brief Import cryptographic key into cipher suite 4.
 *
 ...
 */
int edhoc_cipher_suite_4_key_import(void *user_context,
 ...
 */
int edhoc_cipher_suite_4_key_destroy(void *user_context, void *kid);
 ...
 */
int edhoc_cipher_suite_4_make_key_pair(
 ...
 */
int edhoc_cipher_suite_4_key_agreement(void *user_context, const void *key_id,
 ...
 */
int edhoc_cipher_suite_4_signature(void *user_context, const void *key_id,
 ...
 */
int edhoc_cipher_suite_4_verify(void *user_context, const void *key_id,
				const uint8_t *input, size_t input_length,
 ...
 */
int edhoc_cipher_suite_4_extract(void *user_context, const void *key_id,
 ...
 */
int edhoc_cipher_suite_4_expand(void *user_context, const void *key_id,
 ...
 */
int edhoc_cipher_suite_4_encrypt(void *user_context, const void *key_id,
 ...
 */
int edhoc_cipher_suite_4_decrypt(void *user_context, const void *key_id,
				 const uint8_t *nonce, size_t nonce_length,
				 const uint8_t *additional_data,
				 size_t additional_data_length,
 ...
 */
int edhoc_cipher_suite_4_hash(void *user_context, const uint8_t *input,
			      size_t input_length, uint8_t *hash,
			      size_t hash_size, size_t *hash_length);

/**@}*/

#endif /* EDHOC_CIPHER_SUITE_4_H */
