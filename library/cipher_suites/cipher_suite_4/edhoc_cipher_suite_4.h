 ...
 *
 * \details Reference implementation of EDHOC cipher suite 4
 *          (X25519 / EdDSA / ChaCha20-Poly1305 / SHA-256). The ephemeral key
 ...
 *          through \ref edhoc_cipher_suite_4_get_crypto and
 *          \ref edhoc_cipher_suite_4_get_suite (or the enum getters in
