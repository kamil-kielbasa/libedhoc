...
format:
	...
	$(call print_cf,$(INCLUDE_DIR_TEST)/*.h)
	$(Q)$(CF) $(INCLUDE_DIR_TEST)/*.h
...
cppcheck:
	...
	$(call print_cppcheck, $(SOURCE_DIR_TEST)/*.c)
	$(Q)$(CPPCHECK) $(SOURCE_DIR_TEST)/*.c
...
clean:
	...
	$(call print_rm,$(SOURCE_DIR_MBEDTLS)/*.su)
	$(Q)$(RM) $(SOURCE_DIR_MBEDTLS)/*.su

	$(call print_rm,$(SOURCE_DIR_ZCBOR)/*.o)
	$(Q)$(RM) $(SOURCE_DIR_ZCBOR)/*.o
	$(call print_rm,$(SOURCE_DIR_ZCBOR)/*.su)
	$(Q)$(RM) $(SOURCE_DIR_ZCBOR)/*.su

	$(call print_rm,$(SOURCE_DIR_BACKEND_CBOR)/*.o)
	$(Q)$(RM) $(SOURCE_DIR_BACKEND_CBOR)/*.o
	$(call print_rm,$(SOURCE_DIR_BACKEND_CBOR)/*.su)
	$(Q)$(RM) $(SOURCE_DIR_BACKEND_CBOR)/*.su

	$(call print_rm,$(SOURCE_DIR_APP)/*.o)
	$(Q)$(RM) $(SOURCE_DIR_APP)/*.o
	$(call print_rm,$(SOURCE_DIR_APP)/*.su)
	$(Q)$(RM) $(SOURCE_DIR_APP)/*.su

	$(call print_rm,$(SOURCE_DIR_TEST)/*.o)
	$(Q)$(RM) $(SOURCE_DIR_TEST)/*.o
	$(call print_rm,$(SOURCE_DIR_TEST)/*.su)
	$(Q)$(RM) $(SOURCE_DIR_TEST)/*.su
