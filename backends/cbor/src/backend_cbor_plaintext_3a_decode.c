		...
		zcbor_state_t *state, struct plaintext_3a *result)
{
	...
	bool tmp_result = (((((zcbor_union_start_code(state) && (int_res = ((((zcbor_int32_decode(state, (&(*result).plaintext_3a_ID_CRED_PSK_int)))) && (((*result).plaintext_3a_ID_CRED_PSK_choice = plaintext_3a_ID_CRED_PSK_int_c), true))
	|| (((zcbor_bstr_decode(state, (&(*result).plaintext_3a_ID_CRED_PSK_bstr)))) && (((*result).plaintext_3a_ID_CRED_PSK_choice = plaintext_3a_ID_CRED_PSK_bstr_c), true))
	|| (zcbor_union_elem_code(state) && (((decode_id_cred_x(state, (&(*result).plaintext_3a_ID_CRED_PSK_id_cred_x_m)))) && (((*result).plaintext_3a_ID_CRED_PSK_choice = plaintext_3a_ID_CRED_PSK_id_cred_x_m_c), true)))), zcbor_union_end_code(state), int_res)))
