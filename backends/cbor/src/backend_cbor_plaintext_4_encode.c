...
static bool encode_plaintext_4_EAD_4(zcbor_state_t *state, const struct plaintext_4_EAD_4 *input);
...
static bool encode_plaintext_4_EAD_4(
		zcbor_state_t *state, const struct plaintext_4_EAD_4 *input)
{
	zcbor_print("%s\r\n", __func__);

	bool tmp_result = (zcbor_present_encode(&((*input)._plaintext_4_EAD_4_present), (zcbor_encoder_t *)encode_ead_x, state, (&(*input)._plaintext_4_EAD_4)));
...
int cbor_encode_plaintext_4_EAD_4(
		uint8_t *payload, size_t payload_len,
		const struct plaintext_4_EAD_4 *input,
