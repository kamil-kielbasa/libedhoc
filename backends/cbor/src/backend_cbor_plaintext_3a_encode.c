		...
		zcbor_state_t *state, const struct plaintext_3a *input)
{
	...
	bool tmp_result = (((((((*input).plaintext_3a_ID_CRED_PSK_choice == plaintext_3a_ID_CRED_PSK_int_c) ? ((zcbor_int32_encode(state, (&(*input).plaintext_3a_ID_CRED_PSK_int))))
	...
	: (((*input).plaintext_3a_ID_CRED_PSK_choice == plaintext_3a_ID_CRED_PSK_id_cred_x_m_c) ? ((encode_id_cred_x(state, (&(*input).plaintext_3a_ID_CRED_PSK_id_cred_x_m))))
	: false))))
