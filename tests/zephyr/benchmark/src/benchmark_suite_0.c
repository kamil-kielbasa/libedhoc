/**
 * \file    benchmark_suite_0.c
 * \author  Kamil Kielbasa
 * \brief   Cipher suite 0 (X25519 / EdDSA) benchmark case.
 *
...
ZTEST(edhoc_benchmark, test_suite_0_x25519_eddsa)
{
	...
	const struct benchmark_case bench_case = {
		.name = "cipher suite 0 (X25519 / EdDSA / AES-CCM-16-64-128 / SHA-256), method 0, no EAD",
		.suite_id = EDHOC_CIPHER_SUITE_0,
		.methods = methods,
