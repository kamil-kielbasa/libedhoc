 ...
 */
int cipher_suite_0_make_key_pair(const void *key_id,
 ...
 */
int cipher_suite_0_key_agreement(const void *key_id,
 ...
 */
int cipher_suite_0_signature(const void *key_id, const uint8_t *input,
 ...
 */
int cipher_suite_0_verify(const void *key_id, const uint8_t *input,
 ...
 * \brief HKDF extract.
 */
int cipher_suite_0_extract(const void *key_id, const uint8_t *salt,
 ...
 * \brief HKDF expand.
 */
int cipher_suite_0_expand(const void *key_id, const uint8_t *info,
 ...
 * \brief AEAD encrypt.
 */
int cipher_suite_0_encrypt(const void *key_id, const uint8_t *nonce,
 ...
 * \brief AEAD decrypt.
 */
int cipher_suite_0_decrypt(const void *key_id, const uint8_t *nonce,
			   size_t nonce_length, const uint8_t *additional_data,
			   size_t additional_data_length,
 ...
 * \brief Hash function.
 */
int cipher_suite_0_hash(const uint8_t *input, size_t input_length,
