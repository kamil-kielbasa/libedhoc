/**
 * \file    test_edhoc_handshake_x5chain_cs_2_static_dh_ead.c
...
static const struct edhoc_credentials edhoc_auth_cred_single_cert_mocked_init = {
	.fetch = auth_cred_fetch_init_x5chain_cs_2_static_dh,
	.verify = auth_cred_verify_init_x5chain_cs_2_static_dh,
};

static const struct edhoc_credentials edhoc_auth_cred_single_cert_mocked_resp = {
	.fetch = auth_cred_fetch_resp_x5chain_cs_2_static_dh,
	.verify = auth_cred_verify_resp_x5chain_cs_2_static_dh,
};
