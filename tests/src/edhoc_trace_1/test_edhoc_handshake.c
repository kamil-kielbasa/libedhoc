...
static int cipher_suite_0_make_key_pair_init(const void *kid, uint8_t *priv_key,
...
static int cipher_suite_0_make_key_pair_resp(const void *kid, uint8_t *priv_key,
					     size_t priv_key_size,
					     size_t *priv_key_len,
					     uint8_t *pub_key,
					     size_t pub_key_size,
