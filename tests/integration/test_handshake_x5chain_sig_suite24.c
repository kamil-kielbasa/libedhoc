...
/* Import a raw P-384 scalar as an ECDSA (SIGN_HASH) private key handle. */
...
/* Bind cipher suite 24 to the shared key-agreement probe helper. */
...
{
	test_assert_peers_share_slot_key(EDHOC_CIPHER_SUITE_24, lhs, rhs, slot);
}
