/**
 * \file    test_handshake_x5chain_sig_suite2.c
...
TEST_GROUP(handshake_x5chain_sig_suite2);

TEST_SETUP(handshake_x5chain_sig_suite2)
{
	ret = psa_crypto_init();
...
TEST_TEAR_DOWN(handshake_x5chain_sig_suite2)
{
...
{
	RUN_TEST_CASE(handshake_x5chain_sig_suite2, one_cert_in_chain);
	RUN_TEST_CASE(handshake_x5chain_sig_suite2,
