...
static const struct cipher_suite_descriptor suite = {
	.id = EDHOC_CIPHER_SUITE_0,
	.name = "cipher suite 0 (X25519 / EdDSA / AES-CCM-16-64-128 / SHA-256)",
	.expected = {
		.value = 0,
...
TEST(cipher_suite_0_positive, sign_verify)
{
	cipher_suite_test_sign_verify(&suite);
}

TEST(cipher_suite_0_positive, key_agreement_roundtrip)
{
...
TEST(cipher_suite_0_positive, kdf)
{
...
TEST(cipher_suite_0_positive, aead_empty_plaintext)
{
...
TEST_GROUP_RUNNER(cipher_suite_0_positive)
{
	...
	RUN_TEST_CASE(cipher_suite_0_positive, sign_verify);
	RUN_TEST_CASE(cipher_suite_0_positive, key_agreement_roundtrip);
	RUN_TEST_CASE(cipher_suite_0_positive, kem_roundtrip);
	RUN_TEST_CASE(cipher_suite_0_positive, kdf);
	RUN_TEST_CASE(cipher_suite_0_positive, aead);
	RUN_TEST_CASE(cipher_suite_0_positive, aead_empty_plaintext);
...
TEST(cipher_suite_0_negative, sign_verify_zero_input)
{
	cipher_suite_test_sign_verify_zero_input(&suite);
}

TEST(cipher_suite_0_negative, sign_null_args)
{
	cipher_suite_test_sign_null_args(&suite);
}

TEST(cipher_suite_0_negative, sign_small_buffer)
{
	cipher_suite_test_sign_small_buffer(&suite);
}

TEST(cipher_suite_0_negative, sign_destroyed_key)
{
	cipher_suite_test_sign_destroyed_key(&suite);
}

TEST(cipher_suite_0_negative, sign_non_exportable_key)
{
	cipher_suite_test_sign_non_exportable_key(&suite);
}

TEST(cipher_suite_0_negative, sign_short_key)
{
...
TEST(cipher_suite_0_negative, verify_bitflip_halves)
{
	cipher_suite_test_verify_bitflip_halves(&suite);
}

TEST(cipher_suite_0_negative, verify_bad_signature_length)
{
	cipher_suite_test_verify_bad_signature_length(&suite);
}

TEST(cipher_suite_0_negative, verify_bad_public_key_length)
{
...
TEST(cipher_suite_0_negative, generate_key_pair_small_buffer)
{
...
TEST(cipher_suite_0_negative, destroy_key_null_args)
{
	cipher_suite_test_destroy_key_null_args(&suite);
}

TEST(cipher_suite_0_negative, destroy_key_invalid_handle)
{
...
TEST(cipher_suite_0_negative, expand_output_too_large)
{
	cipher_suite_test_expand_output_too_large(&suite);
}

TEST(cipher_suite_0_negative, aead_tag_tamper)
{
	cipher_suite_test_aead_tag_tamper(&suite);
}

TEST(cipher_suite_0_negative, aead_aad_tamper)
{
...
TEST(cipher_suite_0_negative, hash_small_buffer)
{
...
{
	/* Signature. */
	RUN_TEST_CASE(cipher_suite_0_negative, sign_verify_zero_input);
	RUN_TEST_CASE(cipher_suite_0_negative, sign_null_args);
	RUN_TEST_CASE(cipher_suite_0_negative, sign_small_buffer);
	RUN_TEST_CASE(cipher_suite_0_negative, sign_destroyed_key);
	RUN_TEST_CASE(cipher_suite_0_negative, sign_non_exportable_key);
	RUN_TEST_CASE(cipher_suite_0_negative, sign_short_key);
	RUN_TEST_CASE(cipher_suite_0_negative, verify_null_args);
	RUN_TEST_CASE(cipher_suite_0_negative, verify_corrupted_signature);
	RUN_TEST_CASE(cipher_suite_0_negative, verify_bitflip_halves);
	RUN_TEST_CASE(cipher_suite_0_negative, verify_bad_signature_length);
	RUN_TEST_CASE(cipher_suite_0_negative, verify_bad_public_key_length);

	/* Key exchange and key lifecycle. */
	RUN_TEST_CASE(cipher_suite_0_negative, generate_key_pair_null_args);
	RUN_TEST_CASE(cipher_suite_0_negative, generate_key_pair_small_buffer);
	...
	RUN_TEST_CASE(cipher_suite_0_negative, destroy_key_null_args);
	RUN_TEST_CASE(cipher_suite_0_negative, destroy_key_invalid_handle);
	...
	RUN_TEST_CASE(cipher_suite_0_negative, expand_output_too_large);

	/* AEAD. */
	RUN_TEST_CASE(cipher_suite_0_negative, aead_tag_tamper);
	RUN_TEST_CASE(cipher_suite_0_negative, aead_aad_tamper);
	...
	RUN_TEST_CASE(cipher_suite_0_negative, hash_small_buffer);
}
