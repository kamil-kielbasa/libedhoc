 ...
 */
#define EDHOC_ERROR_BUFFER_TOO_SMALL ((int)-102)

/**
 * \brief The requested action cannot be performed in the current state.
 */
#define EDHOC_ERROR_BAD_STATE ((int)-103)

/**
 * \brief The parameters passed to the function are invalid.
 */
#define EDHOC_ERROR_INVALID_ARGUMENT ((int)-104)
 ...
 */
#define EDHOC_ERROR_DIFFIE_HELLMAN_FAILURE ((int)-133)

/**
 * \brief EDHOC computing of transcript hash failure was detected.
 */
#define EDHOC_ERROR_TRANSCRIPT_HASH_FAILURE ((int)-134)

/**
 * \brief EDHOC computing of pseudorandom key failure was detected.
 */
#define EDHOC_ERROR_PSEUDORANDOM_KEY_FAILURE ((int)-135)

/**
 * \brief EDHOC MAC_2 is incorrect.
 */
#define EDHOC_ERROR_INVALID_MAC_2 ((int)-136)

/**
 * \brief EDHOC Signature_2 or MAC_2 is incorrect.
 */
#define EDHOC_ERROR_INVALID_SIGN_OR_MAC_2 ((int)-137)

/**
 * \brief EDHOC MAC_3 is incorrect.
 */
#define EDHOC_ERROR_INVALID_MAC_3 ((int)-138)

/**
 * \brief EDHOC Signature_3 or MAC_3 is incorrect.
 */
#define EDHOC_ERROR_INVALID_SIGN_OR_MAC_3 ((int)-139)

/**
 * @brief RFC-9528: 3.3.2. Representation of Byte String Identifiers.
 */
#define ONE_BYTE_CBOR_INT_LEN ((size_t)1)
#define ONE_BYTE_CBOR_INT_MIN_VALUE ((int8_t)-24)
#define ONE_BYTE_CBOR_INT_MAX_VALUE ((int8_t)23)
...
#define EDHOC_EXTRACT_PRK_INFO_LABEL_KEY ((size_t)3)
#define EDHOC_EXTRACT_PRK_INFO_LABEL_IV ((size_t)4)
